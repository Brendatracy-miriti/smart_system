...
export default function ProgressRing({ percentage = 0, size = 80, stroke = 8, color = "#3B82F6" }) {
  ...
  return (
    <svg width={size} height={size} className="transform -rotate-90">
      <circle stroke="#e5e7eb" fill="transparent" strokeWidth={stroke} r={radius} cx={size/2} cy={size/2} />
      ...
      <text x="50%" y="55%" textAnchor="middle" fill="#111827" fontSize="12" fontWeight="600">
